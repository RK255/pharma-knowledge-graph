...
STEPS = [
    ...
    },
    {
        ...
        "output": "rxnorm_entities_enriched.jsonl",
        # Passing the specific properties we want to fetch
        "args": ["--properties", "smiles", "inchikey", "iupac_name", "molecular_weight", "pmid"]
    },
    {
        "num": 7,
        "name": "Convert Staging",
        "script": "05_triple_converter/01_convert_staging.py",
        "output": "staging_entities.json",
        "args": []
    },
    {
        "num": 8,
    ...
    },
    {
        ...
        "output": "dailymed_rxnorm_links.json",
        "args": []
    },
    {
        "num": 11,
...
def main():
    ...
    for step in STEPS[start_step-1:end_step]:
        ...
        if step['num'] == 11:  # Provenance step

...
LAYER1_NODES_PATH = "/mnt/fast_raid/server_projects/Geo/graph_workshop/data/import_csvs/Layer1_Nodes_Grab_Subtract_2026-02-10.csv"
RELATIONSHIPS_PATH = "/mnt/fast_raid/server_projects/Geo/graph_workshop/data/import_csvs/Layer0_to_Layer1_Relationships_Grab_Subtract_2026-02-10.csv"

def find_layer1_grab_and_subtract():
    """
    Finds all RxCUIs connected to Layer 0 and then subtracts Layer 0 to get Layer 1.
    """
    print("--- Finding Layer 1 Nodes via 'Grab and Subtract' Method ---")
    ...
    # 2. Scan RXNREL to find ALL RxCUIs involved in relationships with our ingredients
    print(f"\nScanning {RXNREL_PATH} for all involved RxCUIs...")
    ...
    # DEBUG: Print the first 5 RxCUIs we are looking for
    print("DEBUG: First 5 Layer 1 RxCUIs to look up:")
    for rxcui in list(layer1_rxcuis)[:5]:
        print(f"  - {rxcui}")
